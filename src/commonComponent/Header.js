        ...
        <div className="moblie_header_inner">
          ...
          <div className="logo">
            <Link to="/" className="logo_a">
              <img
                src="./images/main/sulwhasoo_orange_logo_220902.png"
                alt="설화수로고"
              ></img>
            </Link>
          </div>
          <div className="search">
            <img
              src="./images/main/icon/search_black_icon.png"
              alt="서치아이콘"
            ></img>
          </div>
        </div>
        ...
        <div className="pc_header_inner">
          <div className="pc_lnb w1100">
            <div className="language_select">
              한국/한국어{" "}
              <img
                src="./images/main/icon/language_arrow_black.png"
                alt="언어선택탭"
                id="language_icon"
              ></img>
            </div>
          ...
          <div className="pc_nav">
            <ul className="pc_gnb_menu">
              ...
              <li className="pc_nav_d1">
                <Link to="spaintroducing" className="d1_menu">
                  스파
                </Link>
                <ul className="pc_nav_d2_box">
                  <div className="pc_nav_d2_container d2_box2">
                    <li className="pc_nav_d2">
                      <Link to="spaintroducing" className="d2_hover">
                        소개
                      </Link>
                    </li>
                    <li className="pc_nav_d2">
          ...
          <div className="sideBox">
            <div className="side_content">
              <ul id="global_nav" className="nav_list">
                ...
                >
                  <Link to="spaintroducing" className="depth_toggle">
                    스파
                  </Link>
                  <ul className="nav_d2_box">
                    <li className="nav_d2">
                      <Link to="spaintroducing" className="nav_d2_menu">
                        소개
                      </Link>
                    </li>
                    <li className="nav_d2">
